<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\brandscate\storeedit.html";i:1529405155;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('brandscate/storeedit'); ?>">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">门店描述：</label>
                            <div class="input-group col-sm-7">
