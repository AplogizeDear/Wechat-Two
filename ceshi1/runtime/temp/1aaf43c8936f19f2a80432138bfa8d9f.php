<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\index.html";i:1529568406;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2017-2019 本后台系统由GOPAR提供技术支持
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
