<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\seat\seatedit.html";i:1528080955;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('seat/seatedit'); ?>">
                        <input type="hidden" name="id" value="<?php echo $seat['id']; ?>"/>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">台桌名称：</label>
                            <div class="input-group col-sm-7">
                                <input id="name" type="text" class="form-control" name="name" required="" aria-required="true" value="<?php echo $seat['name']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">备注说明：</label>
                            <div class="input-group col-sm-7">
                                <textarea id="remark" class="form-control" name="remark" required="" aria-required="true"><?php echo $seat['remark']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
