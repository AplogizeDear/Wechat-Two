<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\member\memberedit.html";i:1528170150;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('member/memberedit'); ?>">
                        <input type="hidden" name="id" value="<?php echo $member['id']; ?>"/>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">积分：</label>
                            <div class="input-group col-sm-7">
                                <input id="point" type="text" class="form-control" name="point" required="" aria-required="true" value="<?php echo $member['point']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">余额：</label>
                            <div class="input-group col-sm-7">
                                <input id="money" type="text" class="form-control" name="money" required="" aria-required="true" value="<?php echo $member['money']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
