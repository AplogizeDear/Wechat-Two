<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\seat\seatadd.html";i:1528076304;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('seat/seatAdd'); ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">台桌名称：</label>
                            <div class="input-group col-sm-7">
                                <input id="title" type="text" class="form-control" name="name" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">备注说明：</label>
                            <div class="input-group col-sm-7">
                                <textarea id="description" class="form-control" name="remark" required="" aria-required="true"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
