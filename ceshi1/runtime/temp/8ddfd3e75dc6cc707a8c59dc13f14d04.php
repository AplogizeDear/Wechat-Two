<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\winetype\winebrandadd.html";i:1528182019;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                ...
                <div class="col-sm-10">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('winetype/winebrandadd'); ?>">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">酒种类：</label>
