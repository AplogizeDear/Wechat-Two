<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\winetype\winetypeadd.html";i:1529993039;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('winetype/winetypeadd'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="use_day" type="text" class="form-control" name="use_day" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
