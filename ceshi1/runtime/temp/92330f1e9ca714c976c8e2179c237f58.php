<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\keepout\keepedit.html";i:1530009078;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('keepout/keepEdit'); ?>">
                        ...
                        <div class="form-group" id="recharge">
                            <?php if(is_array($infos) || $infos instanceof \think\Collection || $infos instanceof \think\Paginator): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <div class="input-group col-sm-7 recharge_s" style="width: 100%" >
                                        ...
                                        <select name="tid_<?php echo $v['id']; ?>" id="tid_<?php echo $v['id']; ?>" class="form-control" style="width:12%" >  
                                            <option value="<?php echo $v['t_id']; ?>"><?php echo $v['type']; ?></option>  
                                        </select>
                                        <label class="col-sm-3 control-label" style="width:10%">酒品牌</label>
                                        <select name="bid_<?php echo $v['id']; ?>" id="bid_<?php echo $v['id']; ?>" class="form-control" style="width:12%">  
                                        ...
                                        <select name="nums_<?php echo $v['id']; ?>" class="form-control" id="nums_<?php echo $v['id']; ?>" style="width:8%">  
                                            <option value="0" <?php if($v['nums'] == 0): ?>selected<?php endif; ?>>无</option> 
                                            <option value="1" <?php if($v['nums'] == 1): ?>selected<?php endif; ?>>1/10</option> 
                                            <option value="2" <?php if($v['nums'] == 2): ?>selected<?php endif; ?>>2/10</option> 
                                            <option value="3" <?php if($v['nums'] == 3): ?>selected<?php endif; ?>>3/10</option> 
                                            <option value="4" <?php if($v['nums'] == 4): ?>selected<?php endif; ?>>4/10</option> 
                                            <option value="5" <?php if($v['nums'] == 5): ?>selected<?php endif; ?>>5/10</option> 
                                            <option value="6" <?php if($v['nums'] == 6): ?>selected<?php endif; ?>>6/10</option> 
                                            <option value="7" <?php if($v['nums'] == 7): ?>selected<?php endif; ?>>7/10</option> 
                                            <option value="8" <?php if($v['nums'] == 8): ?>selected<?php endif; ?>>8/10</option> 
                                            <option value="9" <?php if($v['nums'] == 9): ?>selected<?php endif; ?>>9/10</option> 
                                        </select>
                                        ...
                                        <input id="useday_<?php echo $v['id']; ?>" type="text" class="form-control" name="useday_<?php echo $v['id']; ?>" required="" aria-required="true" value="<?php echo $v['time']; ?>" style="width:12%" >
