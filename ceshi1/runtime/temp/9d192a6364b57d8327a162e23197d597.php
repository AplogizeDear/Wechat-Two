<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\keepout\stocktimeedit.html";i:1529027382;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('keepout/stocktimeEdit'); ?>">
                        <div class="form-group">
                            <input id="id" type="hidden" class="form-control" name="id" required="" aria-required="true" value="<?php echo $id; ?>"  >
                            <label class="col-sm-3 control-label">有效期：</label>
                            <div class="input-group col-sm-7">
                                <input id="useday" type="text" class="form-control" name="useday" required="" aria-required="true" value=""  >
                            </div>
                        </div>
                        <div class="form-group">
