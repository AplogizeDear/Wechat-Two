<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\pay\payadd.html";i:1529376252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('pay/payadd'); ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">用户：</label>
                            <div class="input-group col-sm-7">
                                <input type="hidden" name="m_id" id="m_id" value="" >
                                <a href="javascript:giveQx()"><input name="m_ids" id="m_ids" value="" class="form-control"></a>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="pay" type="text" class="form-control" name="pay" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">消费内容：</label>
                            <div class="input-group col-sm-7">
                                <input id="content" type="text" class="form-control" name="content" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
