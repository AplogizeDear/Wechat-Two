<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\brandscate\storeadd.html";i:1529405040;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('brandscate/storeadd'); ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">集团名称：</label>
                            <div class="input-group col-sm-7">
                                <select name="gid" id='gid' class="form-control" onchange="a(this)">  
                                            <option>--请选择--</option>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <textarea id="content" class="form-control" name="content" required="" aria-required="true"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">品牌图片：</label>
                            <input name="img" id="thumbnail" type="hidden"/>
...
<script type="text/javascript">
    ...
    function a(obj){
                        ...
                        var options=$('#gid option:selected');
                        var id = options.val(); //拿到选中项的值
                        $('#pid').html(brand);//初始化
                        $.getJSON("<?php echo url('brandscate/getStore'); ?>", {'id' : id}, function(res){
                            $.each(res, function(j, val) {  
                                $('#pid').append("<option value=" + j + ">"  + val + "</option>");  
                                }); 
                            })                             
                    }
</script>
