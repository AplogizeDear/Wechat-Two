<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"E:\phpStudy\PHPTutorial\WWW\ceshi1\public/../application/admin\view\card\cardadd.html";i:1529655899;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                ...
                <div class="col-sm-10">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('card/cardadd'); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-7">
                                        <input id="point" type="text" class="form-control" name="point" required="" aria-required="true">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="image" id="thumbnail" type="hidden"/>
